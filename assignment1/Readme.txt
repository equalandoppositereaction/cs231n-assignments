Note: 
  I couldn't get the autorefresh to work so I had to refresh the ipynb after every change in the python files.
  The wandb api key in one of the ipynb is no longer valid so dont waste your time trynna be funny .

Assignment 1

Setup: https://youtu.be/DsGd2e9JNH4?si=_2AC3UtzRJinqfpP
